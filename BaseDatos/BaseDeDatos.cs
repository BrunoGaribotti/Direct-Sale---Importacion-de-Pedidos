    ...
    public class db
    {
        ...
        public  static void Configurar()
        {
            try
            {
                ...
                //cadenaConexion = "data source = 192.168.2.12,1433; initial catalog = BOMBEROS; user id = Axoft; password = Axoft;";                
                //cadenaConexion = "data source = PROGRAMACION-NO,1433; initial catalog =COLOMBRARO_2 ; user id =Axoft; password = Axoft;";
                //cadenaConexion = "data source = SERVERTANGO\\AXSQL; initial catalog =WIDEX_ARGENTINA_SA ; user id =sa; password = Axoft1988;";

                //cadenaConexion = "data source = 186.138.188.55,1433; initial catalog =WIDEX_ARGENTINA_SA ; user id =sa; password = Axoft1988;";
                //cadenaConexion = "data source = PROGRAMACION-NO,1433; initial catalog =COLOMBRARO_2 ; user id =Axoft; password = Axoft;";
