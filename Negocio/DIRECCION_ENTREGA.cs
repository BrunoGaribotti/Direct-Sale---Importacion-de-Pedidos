...
namespace Negocio
{
    public class DIRECCION_ENTREGA
    {
        ...
        public string insert()
        {
           ...
           ,'" + /*SELECT MAX(ID_DIRECCION_ENTREGA) +1  FROM DIRECCION_ENTREGA)*/COD_DIRECCION_ENTREGA + @"'
           ,'" + COD_CLIENTE + @"'
           ,'" + DIRECCION + @"'
           ,'" + COD_PROVINCIA + @"'
           ,'" + LOCALIDAD + @"'
        ...
        public DIRECCION_ENTREGA()
        {
            ...
            ds.ReadXml("CONFIG\\DIRECCION_ENTREGA.xml");
